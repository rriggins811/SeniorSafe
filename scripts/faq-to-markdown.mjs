...
const out = []
out.push('## 19. Using the Hammock365 App: setup and troubleshooting')
out.push('')
out.push('These are the answers the app itself gives in its Help Center. When someone asks how to set up Hammock365, invite family, or fix a check-in or text problem, answer from here in plain words. If the fix is not here, tell them to text Ryan at (336) 553-8933 with what they see on the screen.')
out.push('')
