# SeniorSafe Maggie Knowledge Base
...
## 19. Using the SeniorSafe App: setup and troubleshooting

These are the answers the app itself gives in its Help Center. When someone asks how to set up SeniorSafe, invite family, or fix a check-in or text problem, answer from here in plain words. If the fix is not here, tell them to text Ryan at (336) 553-8933 with what they see on the screen.
