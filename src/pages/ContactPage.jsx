...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F4] flex flex-col">
      {/* Header */}
      <div className="bg-[#1F5A4B] px-6 pt-12 pb-8">
        <div className="max-w-sm mx-auto">
          ...
          <p className="text-[#F2B544] text-sm mt-1">Licensed NC Realtor &amp; Senior Transition Advisor</p>
        </div>
      </div>
      ...
      <div className="flex-1 px-6 py-8 max-w-sm mx-auto w-full flex flex-col gap-4">
        ...
        <div className="text-center text-[#1F5A4B] font-semibold text-lg">
          (336) 553-8933
        </div>
        ...
        <a
          href="sms:3365538933"
          className="w-full flex items-center gap-4 bg-[#1F5A4B] rounded-2xl px-6 py-5 shadow-sm active:opacity-90 no-underline"
        >
        ...
        <button
          ...
          className="w-full flex items-center gap-4 bg-[#F2B544] rounded-2xl px-6 py-5 shadow-sm active:opacity-90 no-underline text-left"
        >
          <div className="bg-white/20 rounded-xl p-3">
            <CalendarDays size={28} color="#1F5A4B" strokeWidth={1.5} />
          </div>
          <div className="flex flex-col items-start">
            <span className="text-[#1F5A4B] font-semibold text-lg">Book a Free Call</span>
            <span className="text-[#1F5A4B]/70 text-sm">Schedule time with Ryan</span>
          </div>
        </button>
        ...
        <a
          ...
          className="w-full flex items-center gap-4 bg-white border-2 border-[#1F5A4B] rounded-2xl px-6 py-5 shadow-sm active:opacity-90 no-underline"
        >
          <div className="bg-[#FAF8F4] rounded-xl p-3">
            <HelpCircle size={28} color="#1F5A4B" strokeWidth={1.5} />
          </div>
          <div className="flex flex-col items-start">
            <span className="text-[#1F5A4B] font-semibold text-lg">Quick Question</span>
