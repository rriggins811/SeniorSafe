export default function EmptyPhotos() {
  return (
    <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="w-full h-full">
      <g fill="none" stroke="#1F5A4B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        {/* Photo frame */}
      ...
      <circle cx="100" cy="93" r="2.5" fill="#F2B544" />
      {/* Gold corner accents on frame */}
      <circle cx="50" cy="50" r="1.5" fill="#F2B544" />
      <circle cx="150" cy="150" r="1.5" fill="#F2B544" />
    </svg>
  )
}
